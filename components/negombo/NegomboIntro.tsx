      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="lg:col-span-5 flex flex-col gap-6 text-emerald-100/80 font-light leading-relaxed text-sm sm:text-base border-l border-[#E5B842]/20 pl-6"
          >
            <p>
              Mosphere Negombo brings luxury salon care to Sri Lanka&apos;s west coast — combining certified hair botox, master haircutting, and calming private suites.
            </p>

            <div className="pt-2">
              <a
                href="#services"
                className="group inline-flex items-center gap-2.5 text-xs uppercase tracking-[0.2em] font-semibold text-[#E5B842] hover:text-[#F3CC68] transition-colors"
              >
                <span>EXPLORE SERVICES</span>
                <ArrowRight className="w-4 h-4 text-[#E5B842] group-hover:translate-x-1.5 transition-transform duration-300" />
              </a>
            </div>
          </motion.div>
