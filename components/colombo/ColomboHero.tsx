...
export default function ColomboHero() {
  return (
    <section
      id="hero"
      className="relative min-h-[100svh] flex flex-col justify-between overflow-hidden pt-28 pb-12 sm:pb-16 px-6 sm:px-12 bg-[#070709]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-8">
            ...
            <motion.h1
              ...
              className="font-serif text-5xl sm:text-7xl md:text-8xl lg:text-[9rem] font-light text-white leading-none tracking-tight -ml-1"
            >
              A MODERN <br />
              <span className="italic font-normal text-mosphere-goldLight">BEAUTY EXPERIENCE.</span>
            </motion.h1>
            ...
            >
              ...
              <span className="font-serif text-xl sm:text-2xl text-mosphere-goldLight italic tracking-wide">
