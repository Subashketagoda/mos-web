...
const defaultGalleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    title: 'Keratin Silk Infusion & Smooth Restoration',
    category: 'Hair Botox',
    aspectRatio: 'portrait',
  },
  {
  ...
  },
  {
    ...
    title: 'Tipsy Tips Luxury Nail Architecture & Gel Extensions',
  ...
  },
  {
    ...
    title: 'Artisanal Nail Artistry & Chrome Glaze',
    category: 'Facial Aesthetics',
    aspectRatio: 'portrait',
  },
  {
...
export default function GalleryAndReviewsPage() {
  ...
  // Submit Photo Handler with Firebase Storage & Dual Sync
  const handleAddPhotoSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If user selected a file from their device, upload it
      if (photoFile) {
      ...
      showToast('Photo uploaded & synced live to gallery!');
      ...
      alert('Error adding photo: ' + (err.message || 'Please check your connection and try again.'));
    } finally {
